...
def load_data(args):
    if args.dataset not in ["ml-small"]:
...
if __name__ == "__main__":
    ...
    # class Args:
    #     def __init__(self, dataset, data_cache_dir, client_num_in_total, model):
    #         self.dataset = dataset
    #         self.data_cache_dir = data_cache_dir
    #         self.client_num_in_total = client_num_in_total
    #         self.model = model

    # args = Args(dataset='ml-small', data_cache_dir='./data', client_num_in_total=610, model='gcn')
