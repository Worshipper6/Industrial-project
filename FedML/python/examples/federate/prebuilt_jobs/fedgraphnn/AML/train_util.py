...
def get_loaders(tr_data, val_data, te_data, tr_inds, val_inds, te_inds, transform, args):
    if isinstance(tr_data, HeteroData):
        ...
        val_loader = LinkNeighborLoader(val_data,num_neighbors=args.num_neighs, batch_size=args.batch_size, shuffle=False, transform=transform)
        te_loader =  LinkNeighborLoader(te_data,num_neighbors=args.num_neighs, batch_size=args.batch_size, shuffle=False, transform=transform)
